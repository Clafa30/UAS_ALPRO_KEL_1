...
void tampilkanDaftarRute() {
  ...
  for (int i = 0; i < 10; i++) {
    cout << i + 1 << ". Jakarta - " << daftarRute[i].tujuan << "\t : Rp " << daftarRute[i].harga << "\n";
  }
}

void jenisPenerbangan(RutePenerbangan rute, KelasPenerbangan kelas) {
    ...
    switch (jenis_penerbangan) {
      case 1:
      	...
      	if(jenis_penerbangan==1){
              ...
              cout << "Pulang - Pergi";
              total_pembayaran = total_pembayaran*2;
            }
              else {
...
void kelasPenerbangan(RutePenerbangan rute, int tujuan_penerbangan) {
  cout << "\n=========================================\n";
  cout << "\nTUJUAN          \t   : "    << rute.tujuan << "\n";
  ...
  jenisPenerbangan(daftarRute[tujuan_penerbangan - 1], daftarKelas[kelas_penerbangan - 1]);
}
